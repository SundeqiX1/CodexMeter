...
悬浮 Widget 默认显示 `5h 76%   W 43%`，悬停时展示两个窗口的重置时间。它始终置顶、不会获取键盘焦点，并会记住最后位置。
...
4. 在主面板点 **Floating Widget**，或从菜单栏右键菜单选择 **Floating Widget**；也可以进入 Settings，勾选 **Show floating widget** 后保存。首次显示在屏幕中央，拖动后会记住位置。
